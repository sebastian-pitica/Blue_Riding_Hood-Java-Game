...
public class Assets {
    ...
    public static final BufferedImage[] zaWalfoLeft = new BufferedImage[7];
    public static final BufferedImage[] zaWalfoRight = new BufferedImage[7];
    ...
    public static final BufferedImage[] wolfLeft = new BufferedImage[7];
    public static final BufferedImage[] wolfRight = new BufferedImage[7];
    ...
    public static void Init() {
        ...
        //fox1&2 sprites load
        {
            ...
            i = getRef2(fox1, fox2, i, fox1Right, fox2Right, fox1Up, fox2Up);
        ...
        //bear1&2 sprites load
        {
            ...
            i = getRef3(bear1, bear2, i, bear1Right, bear2Right, bear1Up, bear2Up);
